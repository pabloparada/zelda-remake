        ...
        public override void Draw(SpriteBatch p_spriteBatch)
        {
            ...
            else
            {
                ...
                p_spriteBatch.DrawString(GraphicAssets.zeldaFont12, "LEVEL-1",
                    new Vector2((parentPosition.X + 13f) * Main.s_scale, (parentPosition.Y + 183f) * Main.s_scale),
                    Color.White, 0f, Vector2.Zero, Main.s_scale / 2f, SpriteEffects.None, 0f);
                ...
                if (Inventory.Instance.hasCompass && mapCounter <= 0.5f)
